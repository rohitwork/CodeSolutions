...
void wrapper()
{
	...
	// if divided as even - cuz total sum is also even and division success
	// OR
	// if sum is odd - all cannot be 2
	// so if there are 2, there should be atleast 2 one's
	// there cannot be one 1 cuz that would be odd sum.
